...
| `adr-0005-market-intelligence-platform-roadmap.md` | **Proposed** — adopts SLL-PROP-DATA-001; Phases 5–9 (v0.7 → v1.1): provenance, extraction+geo, entity resolution+Portal, publication, BizProp+ Reference API; exit criteria per phase; closes Phase 4 |
...
| `SLL-PROP-DATA-001A-domain-data-boundary-v0.1.md` | **001A Domain & Data Boundary** — glossary, ownership/SoR, invariants I1–I10, merge/link rules, BizProp+ consumption boundary, tensions with current code, decisions D1–D7 to freeze |
