...
|---|---|---|---|
| **Extraction** | `extract.claims` | 001C: `review_status = LOW_CONFIDENCE`; or any claim on an observation with `UNCERTAIN` class and lead groups present | `UNREVIEWED` / `LOW_CONFIDENCE` |
